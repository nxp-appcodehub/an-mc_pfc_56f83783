...
#define FMSTR_PLATFORM_56F800E  1   /* Used platform (see freemaster.h for list of all supported platforms) */
...
#define FMSTR_SERIAL_DRV        FMSTR_SERIAL_MCUX_QSCI   // When using FMSTR_SERIAL: select Serial low-level communication driver

//! Define communication interface base address or leave undefined for runtime setting
#define FMSTR_SERIAL_BASE       QSCI0
